...
const formatUser = (title) => {
    ...
    return new Promise((resolve, reject) => {
        setTimeout(() => { resolve(( users.map((data) => { 
...
const findByName = (name) => {
        ...
        return new Promise((resolve, reject) => {
            setTimeout(() => { resolve(( users.find((name) => { return name; })
                ), 2000)
            })
...
const filterByMajor = (major) => {
        ...
        return new Promise((resolve, reject) => {
            setTimeout(() => { resolve(( users.filter((name) => { return name.major + users; })
                ), 4000)
            })
